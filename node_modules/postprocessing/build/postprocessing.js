...
var POSTPROCESSING = (() => {
  ...
  var GammaCorrectionEffect = class extends Effect {
    ...
    constructor({ blendFunction = BlendFunction.SRC, gamma = 2 } = {}) {
      super("GammaCorrectionEffect", gamma_correction_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["gamma", new import_three29.Uniform(gamma)]
        ])
      });
    }
  };
  ...
  function getNoise(size, format, type) {
    const channels = /* @__PURE__ */ new Map([
      [import_three30.LuminanceFormat, 1],
      [import_three30.RedFormat, 1],
      [import_three30.RGFormat, 2],
      [import_three30.RGBAFormat, 4]
    ]);
    let data;
    if (!channels.has(format)) {
      console.error("Invalid noise texture format");
    }
    if (type === import_three30.UnsignedByteType) {
  ...
  var NoiseTexture = class extends import_three30.DataTexture {
    /**
     ...
     */
    constructor(width, height, format = import_three30.LuminanceFormat, type = import_three30.UnsignedByteType) {
  ...
  var v2 = /* @__PURE__ */ new import_three48.Vector3();
  var ab = /* @__PURE__ */ new import_three48.Vector3();
  var ShockWaveEffect = class extends Effect {
     ...
     */
    constructor(camera, position = new import_three48.Vector3(), {
      speed = 2,
      maxRadius = 1,
      waveSize = 0.2,
      amplitude = 0.05
      ...
      super("ShockWaveEffect", shock_wave_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["center", new import_three48.Uniform(new import_three48.Vector2(0.5, 0.5))],
          ["cameraDistance", new import_three48.Uniform(1)],
          ["size", new import_three48.Uniform(1)],
          ["radius", new import_three48.Uniform(-waveSize)],
          ["maxRadius", new import_three48.Uniform(maxRadius)],
          ["waveSize", new import_three48.Uniform(waveSize)],
          ["amplitude", new import_three48.Uniform(amplitude)]
        ])
      });
  ...
  // src/materials/SSAOMaterial.js
  var SSAOMaterial = class extends import_three54.ShaderMaterial {
    /**
    ...
    constructor(camera) {
      super({
        ...
        uniforms: {
          depthBuffer: new import_three54.Uniform(null),
          normalBuffer: new import_three54.Uniform(null),
          normalDepthBuffer: new import_three54.Uniform(null),
          noiseTexture: new import_three54.Uniform(null),
          inverseProjectionMatrix: new import_three54.Uniform(new import_three54.Matrix4()),
          projectionMatrix: new import_three54.Uniform(new import_three54.Matrix4()),
          texelSize: new import_three54.Uniform(new import_three54.Vector2()),
          cameraNearFar: new import_three54.Uniform(new import_three54.Vector2()),
          distanceCutoff: new import_three54.Uniform(new import_three54.Vector2()),
          proximityCutoff: new import_three54.Uniform(new import_three54.Vector2()),
          noiseScale: new import_three54.Uniform(new import_three54.Vector2()),
          minRadiusScale: new import_three54.Uniform(0.33),
          intensity: new import_three54.Uniform(1),
          fade: new import_three54.Uniform(0.01),
          bias: new import_three54.Uniform(0)
        },
     ...
     * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing strategy.
     */
    setDepthBuffer(buffer, depthPacking = import_three54.BasicDepthPacking) {
      this.depthBuffer = buffer;
      this.depthPacking = depthPacking;
    }
    /**
    ...
    copyCameraSettings(camera) {
      if (camera) {
        ...
        if (camera instanceof import_three54.PerspectiveCamera) {
          this.defines.PERSPECTIVE_CAMERA = "1";
        } else {
          delete this.defines.PERSPECTIVE_CAMERA;
        }
  ...
  // src/materials/DepthDownsamplingMaterial.js
  var DepthDownsamplingMaterial = class extends import_three55.ShaderMaterial {
    /**
  ...
  var DepthDownsamplingPass = class extends Pass {
    ...
    constructor({
      ...
      this.needsSwap = false;
      this.renderTarget = new import_three56.WebGLRenderTarget(1, 1, {
        minFilter: import_three56.NearestFilter,
        magFilter: import_three56.NearestFilter,
        depthBuffer: false,
        type: import_three56.FloatType
      });
  ...
  var SSAOEffect = class extends Effect {
    ...
    constructor(camera, normalBuffer, {
      ...
      super("SSAOEffect", ssao_default3, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["aoBuffer", new import_three57.Uniform(null)],
          ["normalDepthBuffer", new import_three57.Uniform(normalDepthBuffer)],
          ["luminanceInfluence", new import_three57.Uniform(luminanceInfluence)],
          ["color", new import_three57.Uniform(null)],
          ["intensity", new import_three57.Uniform(intensity)],
          ["scale", new import_three57.Uniform(0)]
          // Unused.
        ])
      });
      this.renderTarget = new import_three57.WebGLRenderTarget(1, 1, { depthBuffer: false });
  ...
  var ToneMappingEffect = class extends Effect {
    ...
    set mode(value) {
      ...
      const revision = import_three63.REVISION.replace(/\D+/g, "");
